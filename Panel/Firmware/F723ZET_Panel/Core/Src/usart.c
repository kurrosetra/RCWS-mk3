...
uint8_t rxPEBuffer[RING_BUFFER_RX_SIZE];
uint8_t txPEBuffer[RING_BUFFER_TX_SIZE];
TSerial pcE;

//uint8_t rxPSBuffer[RING_BUFFER_RX_SIZE];
//uint8_t txPSBuffer[RING_BUFFER_TX_SIZE];
//TSerial pcS;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, PC_S_RXD_Pin|PC_S_TXD_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, PC_E_RXD_Pin|PC_E_TXD_Pin);
