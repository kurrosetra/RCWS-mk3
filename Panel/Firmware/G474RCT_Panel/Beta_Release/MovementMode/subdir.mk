...
C_SRCS += \
../MovementMode/movement.c 

OBJS += \
./MovementMode/movement.o 

C_DEPS += \
./MovementMode/movement.d 


# Each subdirectory must supply rules for building sources it contributes
MovementMode/%.o MovementMode/%.su: ../MovementMode/%.c MovementMode/subdir.mk
...
clean: clean-MovementMode

clean-MovementMode:
	-$(RM) ./MovementMode/movement.d ./MovementMode/movement.o ./MovementMode/movement.su

.PHONY: clean-MovementMode
