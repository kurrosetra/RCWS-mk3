...
#ifndef INGENIA_FDCANSERVODRIVER_H_
#define INGENIA_FDCANSERVODRIVER_H_

#include "fdcan_buffer.h"

#define MOTOR_DRIVER_DEBUG		0
...
#endif /* INGENIA_FDCANSERVODRIVER_H_ */
