...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(LRF_ENABLE_GPIO_Port, LRF_ENABLE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, THERMAL_ENABLE_Pin|CAMERA_SELECT_Pin|LED_BUILTIN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CAMERA_DISABLE_GPIO_Port, CAMERA_DISABLE_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = CAMERA_SELECT_Pin|LED_BUILTIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = CAMERA_DISABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAMERA_DISABLE_GPIO_Port, &GPIO_InitStruct);
