...
/*      PRIVATE FUNCTIONS       */
/********************************/
__weak uint32_t _VISCA_write_packet_data(VISCAInterface_t *iface, VISCACamera_t *camera,
...
__weak uint32_t _VISCA_get_packet(VISCAInterface_t *iface)
{
	uint32_t pos = 0;
...
__weak uint32_t VISCA_unread_bytes(VISCAInterface_t *iface, unsigned char *buffer,
...
uint32_t VISCA_set_zoom_and_focus_value(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_set_high_resolution_mode(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint8_t power)
{
	VISCAPacket_t packet;
	...
	_VISCA_append_byte(&packet, VISCA_COMMAND);
	_VISCA_append_byte(&packet, VISCA_CATEGORY_CAMERA1);
	_VISCA_append_byte(&packet, VISCA_HIGH_RESOLUTION_MODE);
	_VISCA_append_byte(&packet, power);
...
uint32_t VISCA_set_digital_effect_level(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint8_t level)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_date_time(VISCAInterface_t *iface, VISCACamera_t *camera, uint32_t year,
...
uint32_t VISCA_set_title_params(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_set_spot_ae_position(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_get_digital_effect_level(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint16_t *value)
{
	VISCAPacket_t packet;
	uint32_t err;
...
uint32_t VISCA_set_pantilt_up(VISCAInterface_t *iface, VISCACamera_t *camera, uint32_t pan_speed,
		uint32_t tilt_speed)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_pantilt_upleft(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_set_pantilt_upright(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint32_t pan_speed, uint32_t tilt_speed)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_pantilt_downleft(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint32_t pan_speed, uint32_t tilt_speed)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_pantilt_downright(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint32_t pan_speed, uint32_t tilt_speed)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_pantilt_absolute_position(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_set_pantilt_relative_position(VISCAInterface_t *iface, VISCACamera_t *camera,
		uint32_t pan_speed, uint32_t tilt_speed, int pan_position, int tilt_position)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_set_pantilt_limit_upright(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_set_pantilt_limit_downleft(VISCAInterface_t *iface, VISCACamera_t *camera,
		int pan_position, int tilt_position)
{
	VISCAPacket_t packet;
...
uint32_t VISCA_get_pantilt_maxspeed(VISCAInterface_t *iface, VISCACamera_t *camera,
...
uint32_t VISCA_get_pantilt_position(VISCAInterface_t *iface, VISCACamera_t *camera,
		int *pan_position, int *tilt_position)
{
	VISCAPacket_t packet;
	uint32_t err;
