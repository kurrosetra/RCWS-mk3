...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PC1     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(GPIOC, LRF_TXD_Pin|LRF_RXD_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(THERMAL_RXD_GPIO_Port, THERMAL_RXD_Pin);

    HAL_GPIO_DeInit(THERMAL_TXD_GPIO_Port, THERMAL_TXD_Pin);
